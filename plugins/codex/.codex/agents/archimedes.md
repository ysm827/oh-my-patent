...
Archimedes - 专利交底书主流程编排

## Codex Invocation

Use this prompt as the primary workflow orchestrator. In Codex, prefer starting from natural language in the workspace root so AGENTS.md can route the request.
